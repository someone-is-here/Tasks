...
from StationControlApp.views import stations, StationsList, ShowStation, RegisterUser, AddStation, LoginUser, \
    logout_user, DeleteStation, UpdateStation, AddIndication, ShowState
...
urlpatterns = [
    ...
    path('stations/<int:station_id>/state/', ShowState.as_view(), name='state'),
    path('stations/<int:station_id>/state/create', AddIndication.as_view(), name='create_indication'),
]
